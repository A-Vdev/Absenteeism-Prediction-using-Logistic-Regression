...
class absenteeism_model():
    ...
    def load_and_clean_data(self,data_file):
        ...
        column_names = ['Date', 'Transportation Expense', 'Distance to Work', 'Age',
                           ...
                           'Pets', 'Absenteeism Time in Hours', 'Reason Type 1', 'Reason Type 2','Reason Type 3',  'Reason Type 4']
        ...
        df = df.drop(['Date'], axis = 1)
            ...
            # re-order the columns in df
        column_names_upd = ['Reason Type 1', 'Reason Type 2','Reason Type 3',  'Reason Type 4', 'Month Value', 'Day of the Week'
